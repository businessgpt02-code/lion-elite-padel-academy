    ...
    <div className="w-full bg-[#030303] min-h-screen pt-32 pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 mb-32">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="uppercase tracking-[0.3em] text-[#ccff00] text-sm font-bold">The Legacy</span>
          </div>
      ...
      <div className="container mx-auto px-6">
          ...
          <div className="lg:col-span-5">
            <FadeUp>
              <div className="relative aspect-[3/4] rounded-none overflow-hidden group">
                <div className="absolute inset-0 bg-[#ccff00] opacity-20 mix-blend-overlay z-10 group-hover:opacity-0 transition-opacity duration-700"></div>
                <img 
                  src="https://images.unsplash.com/photo-1622227922682-5ceafad929da?q=80&w=2940&auto=format&fit=crop" 
                  alt="Padel Court" 
                  className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000"
                />
                <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#ccff00] z-0 blur-[50px] opacity-50"></div>
              </div>
            </FadeUp>
          </div>
          ...
          <div className="lg:col-span-7">
            <FadeUp delay={0.2}>
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight mb-8">
                A Breed <span className="text-[#ccff00]">Apart</span>
              </h2>
              <div className="space-y-8 text-gray-400 font-light text-lg lg:text-xl leading-relaxed">
                ...
                <div className="pl-6 border-l-2 border-[#ccff00]">
        ...
        <div className="relative mb-40">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#ccff00] opacity-[0.02] blur-[120px] rounded-full pointer-events-none"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            ...
            <FadeUp delay={0.3} className="md:mt-24">
              <div className="glass-card-premium p-12 lg:p-16 h-full flex flex-col justify-between group bg-gradient-to-br from-[#111] to-[#050505]">
                <h3 className="text-6xl font-black mb-8 text-stroke text-transparent group-hover:text-[#ccff00] transition-colors duration-500 uppercase tracking-tighter">Vision</h3>
                <p className="text-gray-400 leading-relaxed text-lg font-light">
        ...
        <div className="mb-20">
          <FadeUp>
            <div className="flex items-center gap-4 mb-16">
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight">Core <span className="text-[#ccff00]">DNA</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 border-t border-l border-white/10">
            {[
              ...
              <FadeUp key={idx} delay={idx * 0.1}>
                <div className="p-12 lg:p-16 border-r border-b border-white/10 hover:bg-[#ccff00]/5 transition-colors duration-500 group relative overflow-hidden h-full">
                  <div className="absolute top-0 right-0 p-8 text-8xl font-black text-white/5 group-hover:text-[#ccff00]/10 transition-colors duration-500 pointer-events-none">
                    0{idx + 1}
                  </div>
